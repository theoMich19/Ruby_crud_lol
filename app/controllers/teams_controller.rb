class TeamsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @team.save
        format.html { redirect_to team_url(@team), notice: "L'équipe a été créée avec succès." }
  ...
  def update
    respond_to do |format|
      if @team.update(team_params)
        format.html { redirect_to team_url(@team), notice: "L'équipe a été modifiée avec succès." }
